...
const { insertNewPedidoCamping, getPedidoCamping, getPedidoCampingById, removePedidoCampingById, updateOnePedidoCampingById } = require('../controllers/camping.controller');
const router = Router();
